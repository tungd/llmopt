...
| Benchmark correctness and measurement | Exact logits/token parity, retrieval and response-format results, request counts, raw TTFT/TPOT, ERS, and cache-hit accounting are written by reproducible commands | The current full-Q8 trace records 4/4 exact native/eager scored sequences, native/eager ERS `0.3908962321067631/0.3663754874502978`, median native TTFT/TPOT `71.477/7.311 ms`, and 80/194 cached prompt tokens. The current long matrix retrieves 6/6 and matches all 12 established eager-Q8 IDs, while exact-only text is 0/6 | partial |
