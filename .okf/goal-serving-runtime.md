...
| Generated serving-package ABI | Versioned package contains graph schedule, kernel entry points, one memory-mappable tensor archive, and cache layout; OCaml validates it | Package ABI v2 and JSON-free weight ABI v1 validate on the fixture. The 835-command, 241-binding model package predates these ABIs and has not been regenerated; full scheduled-kernel coverage and native invocation metadata remain incomplete | partial |
