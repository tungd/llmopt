...
* [Target model](target-lfm25.md) - LFM2.5-2.6B facts and target-specific constants.
...
* [LFM2.5-350M probe](experiments/exp-0006-lfm25-350m-probe.md) - smaller-model benchmark path kept separate from the 2.6B target.
