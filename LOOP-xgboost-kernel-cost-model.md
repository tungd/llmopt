...
- [ ] **ITEM-06**: End-to-End Model Verification and Differential Benchmark
  ...
  - `NEEDS EVIDENCE`: The current artifacts establish the stated parity pairs and raw timings but do not establish the checklist's $\ge 15\%$ static-versus-dynamic Q8 linear speedup on non-square shapes, so this item remains unchecked.
