...
| Complete 350M operation schedule | partial | The real manifest-v2 no-cache forward has 835 commands: 793 typed/lowered and 42 opaque. It structurally validates with 241 archive tensors and three declared kernels; remaining opaque families, decode/KV-state graphs, generated-kernel coverage, and native command interpretation remain open |
