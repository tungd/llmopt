...
| OCaml FX importer and effect planner | implemented for the current primitive vocabulary; real v2 model recapture pending | typed arguments, ellipsis, N-dimensional logical shapes, pointwise/reduction/cast/movement primitives, deferred chunk/getitem slices, concat, and fused RMSNorm survive effect capture and binary schedule round-trip |
