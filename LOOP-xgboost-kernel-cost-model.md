...
- [ ] **ITEM-06**: End-to-End Model Verification and Differential Benchmark
  ...
  - `NEEDS PLAN`: The repaired selector improves the paired static median by `0.3557436715508102` on the 45-shape holdout and `0.320402858554732` across grouped folds, while the declared `>= 15%` Q8-linear speedup and exact four-prompt full-model result remain unproven. The corrected v4 package was not dispatched after the single native attempt.
