...
| native tokenization and LFM chat formatting | implemented offline; request integration open | `LLMOPTTK` ABI-v1 stores 64,402 tokens and 63,683 merges in 2,284,649 bytes; native OCaml matches 10/10 text/decode and 6/6 typed chat cases against Transformers without runtime JSON or Jinja |
