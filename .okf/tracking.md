...
| Complete 350M operation schedule | partial | Offline replan of the real manifest-v2 no-cache forward has 835 commands: 823 typed/lowered and 12 opaque. The serving package validates 241 archive tensors and five declared kernels; remaining opaque families, decode/KV-state graphs, generated-kernel coverage, and native command interpretation remain open |
