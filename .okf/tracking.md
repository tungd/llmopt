...
| OCaml Metal serving loader and dispatch | schedule batching and repeated Q8 decode execute; exact logits open | one ordered command buffer now carries each schedule's compute and copy commands. The primitive probe retains 39/39 exact outputs; a matched HTTP trace retains 4/4 eager token sequences while ERS rises from `0.06169548638841863` to `0.11058587181748172` |
