...
| Metal compilation artifacts | Package build emits loadable metallib kernels for every scheduled model operation | Binary-input ABI-v11 replanning compiles 60 prefill and 58 decode entries, including tiled and one-row Q8+SiLU, Q8+residual, and Q8 multiplied-input/residual families plus FP16/Q8 cache conversion. Both generated MSL programs compile; the newest materialized-reference fixture remains unlaunched | implemented for captured templates |
